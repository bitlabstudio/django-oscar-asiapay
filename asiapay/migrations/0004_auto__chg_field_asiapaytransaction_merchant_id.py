...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'AsiaPayTransaction.merchant_id'
        raise RuntimeError("Cannot reverse this migration. 'AsiaPayTransaction.merchant_id' and its values cannot be restored.")

        # The following code is provided here to aid in writing a correct migration
        # Changing field 'AsiaPayTransaction.merchant_id'
        db.alter_column(u'asiapay_asiapaytransaction', 'merchant_id', self.gf('django.db.models.fields.IntegerField')())
